...
public class DemoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Etudiant etud1 = etudiantRepostiroy.save(new Etudiant(null, (long) 122, 500.79f, false, null));
		Etudiant etud2 = etudiantRepostiroy.save(new Etudiant(null, (long) 433, 800.33f, false, null));
